      ...
      <div className="flex flex-row   flex-wrap mt-10 max-w-screen-xl mx-auto justify-center gap-[150px]">
        <div>
            ...
            <ul className="text-gray-500 dark:text-gray-400 font-medium">
                ...
                <li className="mb-4">
                    <a href="#" className="font-ubuntu hover:underline">Careers</a>
                </li>
                <li className="mb-4">
                    <a href="#" className="font-ubuntu hover:underline">Brand Center</a>
                </li>
                <li className="mb-4">
                    <a href="#" className="font-ubuntu hover:underline">Blog</a>
                </li>
            </ul>
        </div>
        <div>
            ...
            <ul className="text-gray-500 dark:text-gray-400 font-medium">
                ...
                <li className="mb-4">
                    <a href="#" className="font-ubuntu hover:underline">Twitter</a>
                </li>
                <li className="mb-4">
                    <a href="#" className="font-ubuntu hover:underline">Facebook</a>
                </li>
                <li className="mb-4">
                    <a href="#" className="font-ubuntu hover:underline">Contact Us</a>
                </li>
            </ul>
        </div>
        <div>
            ...
            <ul className="text-gray-500 dark:text-gray-400 font-medium">
                ...
                <li className="mb-4">
                    <a href="#" className="font-ubuntu hover:underline">Licensing</a>
                </li>
                <li className="mb-4">
                    <a href="#" className="font-ubuntu hover:underline">Terms &amp; Conditions</a>
                </li>
            </ul>
        </div>
        <div>
            ...
            <ul className="text-gray-500 dark:text-gray-400 font-medium">
                ...
                <li className="mb-4">
                    <a href="#" className="font-ubuntu hover:underline">Android</a>
                </li>
                <li className="mb-4">
                    <a href="#" className="font-ubuntu hover:underline">Windows</a>
                </li>
                <li className="mb-4">
                    <a href="#" className="font-ubuntu hover:underline">MacOS</a>
                </li>
            </ul>
        </div>
    </div>
